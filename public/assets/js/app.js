...
// initialize app
angular.module('intranet', ['ngMaterial', 'ngAnimate', 'ngAria', 'ngMessages', 'ngRoute', 'ui.router', 'ui.router.state.events', 'cl.paging', 'googlechart', 'ngValidate', 'lfNgMdFileInput', 'md.data.table'])
